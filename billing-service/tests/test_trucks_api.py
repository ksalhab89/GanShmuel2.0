...
class TestTrucksAPI:
    ...
    @pytest.mark.asyncio
    async def test_register_truck_success(self, test_client: AsyncClient, sample_provider):
        """Test registering a new truck via API."""
        response = await test_client.post("/truck", json={
            "id": "TRUCK123",
    ...
    @pytest.mark.asyncio
    async def test_register_truck_upsert(self, test_client: AsyncClient, sample_truck, sample_provider_2):
        """Test truck registration upsert - update existing truck."""
        # Register same truck with different provider
        response = await test_client.post("/truck", json={
            "id": sample_truck.id,
            "provider_id": sample_provider_2.id
        })
    ...
    @pytest.mark.asyncio
    async def test_register_truck_invalid_provider(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_validation_error_missing_id(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_validation_error_missing_provider_id(self, test_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_max_length_id(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_over_max_length_id(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_truck_success(self, test_client: AsyncClient, sample_truck, sample_provider_2):
    ...
    @pytest.mark.asyncio
    async def test_update_truck_not_found(self, test_client: AsyncClient, sample_provider, clean_database):
        """Test updating non-existent truck returns 404."""
        response = await test_client.put("/truck/NONEXIST", json={
            "provider_id": sample_provider.id
        })
    ...
    @pytest.mark.asyncio
    async def test_update_truck_invalid_provider(self, test_client: AsyncClient, sample_truck):
    ...
    @pytest.mark.asyncio
    async def test_update_truck_validation_error_missing_provider_id(self, test_client: AsyncClient, sample_truck):
    ...
    @pytest.mark.asyncio
    async def test_get_truck_details_not_found_in_billing(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_multiple_trucks_registration(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_truck_lifecycle(self, test_client: AsyncClient, sample_provider, sample_provider_2):
        """Test complete truck lifecycle: register and update."""
        truck_id = "LIFECYCLE"

        # Register
        register_response = await test_client.post("/truck", json={
            "id": truck_id,
            "provider_id": sample_provider.id
        })
        ...
        # Update provider
        update_response = await test_client.put(f"/truck/{truck_id}", json={
            "provider_id": sample_provider_2.id
        })
...
class TestTrucksAPIEdgeCases:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="TODO: Fix later")
    async def test_register_truck_empty_id(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_special_characters(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_register_truck_numeric_id(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_truck_same_provider(self, test_client: AsyncClient, sample_truck):
        """Test updating truck with same provider."""
        response = await test_client.put(f"/truck/{sample_truck.id}", json={
            "provider_id": sample_truck.provider_id
        })
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="TODO: Fix later")
    async def test_get_truck_details_invalid_date_format(self, test_client: AsyncClient, sample_truck):
