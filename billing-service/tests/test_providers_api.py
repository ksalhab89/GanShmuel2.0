...
class TestProvidersAPI:
    ...
    @pytest.mark.asyncio
    async def test_create_provider_success(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_validation_error_empty_name(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_validation_error_missing_name(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_duplicate_name(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_long_name(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_special_characters(self, test_client: AsyncClient, clean_database):
        """Test creating provider with special characters in name."""
        response = await test_client.post("/provider", json={
            "name": "Test & Provider #1 (2025)"
        })
    ...
    @pytest.mark.asyncio
    async def test_create_provider_international_name(self, test_client: AsyncClient, clean_database):
        """Test creating provider with international name."""
        response = await test_client.post("/provider", json={
            "name": "International Provider GmbH"
        })
    ...
    @pytest.mark.asyncio
    async def test_update_provider_success(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_not_found(self, test_client: AsyncClient, clean_database):
        """Test updating non-existent provider returns 404."""
        response = await test_client.put("/provider/99999", json={
            "name": "New Name"
        })
    ...
    @pytest.mark.asyncio
    async def test_update_provider_duplicate_name(self, test_client: AsyncClient, sample_provider, sample_provider_2):
        """Test updating provider with duplicate name returns 409."""
        response = await test_client.put(f"/provider/{sample_provider.id}", json={
            "name": sample_provider_2.name
        })
    ...
    @pytest.mark.asyncio
    async def test_update_provider_same_name(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_validation_error_empty_name(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_validation_error_missing_name(self, test_client: AsyncClient, sample_provider):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_invalid_id_format(self, test_client: AsyncClient, clean_database):
        """Test updating provider with invalid ID format."""
        response = await test_client.put("/provider/invalid", json={
            "name": "New Name"
        })
    ...
    @pytest.mark.asyncio
    async def test_multiple_providers_creation(self, test_client: AsyncClient, clean_database):
    ...
    async def test_provider_lifecycle(self, test_client: AsyncClient, clean_database):
        ...
        # Create
        create_response = await test_client.post("/provider", json={
        ...
        # Update
        update_response = await test_client.put(f"/provider/{provider_id}", json={
...
class TestProvidersAPIEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_create_provider_whitespace_name(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_create_provider_with_newlines(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_zero_id(self, test_client: AsyncClient, clean_database):
        """Test updating provider with ID 0."""
        response = await test_client.put("/provider/0", json={
            "name": "Zero ID Provider"
        })

        assert response.status_code == 404

    @pytest.mark.asyncio
    async def test_update_provider_negative_id(self, test_client: AsyncClient, clean_database):
        """Test updating provider with negative ID."""
        response = await test_client.put("/provider/-1", json={
            "name": "Negative ID Provider"
        })
...
class TestProvidersAPIConcurrency:
    ...
    async def test_concurrent_provider_creation_same_name(self, test_client: AsyncClient, clean_database):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_provider_updates(self, test_client: AsyncClient, sample_provider):
        """Test concurrent updates to same provider."""
        import asyncio

        async def update_provider(name: str):
            return await test_client.put(f"/provider/{sample_provider.id}", json={"name": name})

        # Try to update same provider with different names concurrently
        results = await asyncio.gather(
            update_provider("Name A"),
            update_provider("Name B"),
            return_exceptions=True
        )
