...
from ..models.schemas import RateUpload, RateUploadResponse, Rate
from ..models.repositories import RateRepository
from ..utils.excel_handler import read_rates_from_excel, read_rates_from_file, create_rates_excel
...
async def get_rates(format: str = Query("excel", description="Response format: 'json' or 'excel'")):
    """
