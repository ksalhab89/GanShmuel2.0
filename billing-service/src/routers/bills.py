...
async def generate_bill(
    ...
    try:
        ...
        logger.info(f"Generated bill for provider {provider_id}: {bill.total} agorot total")
        return bill
        
    except NotFoundError as e:
        logger.warning(f"Attempt to generate bill for non-existent provider: {provider_id}")
