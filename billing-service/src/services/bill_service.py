...
from ..models.database import Provider, Truck, Rate
from ..models.repositories import ProviderRepository, TruckRepository, RateRepository
...
class BillService:
    ...
    async def generate_bill(
        ...
        provider_transactions = self._filter_provider_transactions(transactions, truck_ids)
